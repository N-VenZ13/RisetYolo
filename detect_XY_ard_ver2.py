...
def main():
    ...
    while True:
        ...
        current_data = "0,0\n"  # Default saat bola tidak terdeteksi
        ...
        # Kirim hanya jika data berbeda dari yang terakhir dikirim
        ...
        # inn buat baca serual dari arudino soalnya hgabisa baca berbarengan kalau lag irun
